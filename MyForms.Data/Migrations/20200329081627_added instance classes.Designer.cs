...
namespace MyForms.Data.Migrations
{
    ...
    [Migration("20200329081627_added instance classes")]
    partial class addedinstanceclasses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("myForms.Core.FieldInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("myForms.Core.FormInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("myForms.Core.FormSectionInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("myForms.Core.ListFieldValueInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("myForms.Core.MultiSelectValueInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("myForms.Core.ListFieldInstance", b =>
                {
                    b.HasBaseType("myForms.Core.FieldInstance");

                    b.HasDiscriminator().HasValue("ListFieldInstance");
                });

            modelBuilder.Entity("myForms.Core.MultiSelectFieldInstance", b =>
                {
                    b.HasBaseType("myForms.Core.FieldInstance");
            ...
            modelBuilder.Entity("myForms.Core.SimpleFieldInstance", b =>
                {
                    b.HasBaseType("myForms.Core.FieldInstance");
            ...
            modelBuilder.Entity("myForms.Core.FieldInstance", b =>
                {
                    ...
                    b.HasOne("myForms.Core.FormSectionInstance", "FormSectionInstance")
                        .WithMany("Fields")
            ...
            modelBuilder.Entity("myForms.Core.FormSectionInstance", b =>
                {
                    b.HasOne("myForms.Core.FormInstance", "FormInstance")
                        .WithMany("Sections")
            ...
            modelBuilder.Entity("myForms.Core.ListFieldValueInstance", b =>
                {
                    b.HasOne("myForms.Core.ListFieldInstance", "FieldInstance")
                        .WithMany("Values")
            ...
            modelBuilder.Entity("myForms.Core.MultiSelectValueInstance", b =>
                {
                    b.HasOne("myForms.Core.MultiSelectFieldInstance", "FieldInstance")
                        .WithMany("Values")
                        .HasForeignKey("FieldInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
